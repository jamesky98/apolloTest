 ...
 */
async function item_base_case_record_03_gnss_idToitem_base(
  parent,
  args,
  context
) {
 ...
 * @param {{ prisma: Prisma }} context
 */
async function item_base_case_record_03_imu_idToitem_base(
  parent,
  args,
  context
) {
...
async function employee_case_record_03_chk_person_idToemployee(
  parent,
  args,
  context
) {
...
async function employee_case_record_03_sign_person_idToemployee(
  parent,
  args,
  context
) {
